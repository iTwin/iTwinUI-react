...
>((props, ref) => {
  ...
  const {
    isVisible = dialogContent.isOpen,
    onClose = dialogContent.onClose,
    isDismissible = dialogContent.isDismissible,
    closeOnExternalClick = dialogContent.closeOnExternalClick,
    closeOnEsc = dialogContent.closeOnEsc,
    onKeyDown,
    onMouseDown,
